...
**Version:** V0.2 + V0.3 System Design supplement + V0.4 Business Decision traceability
**Date:** 2026-08-18
**Status:** V0.3 architecture/module/API domain boundary Accepted; V0.4 Business Decisions Approved/Applied (2026-08-18); V0.2 Requirement → Use Case → Screen remains Review Ready; P0 UI prototype implementation/test linked
...
|---|---|---|---|---|---|
| `USR-001..USR-003`; `UC-AUTH-001`, `UC-AUTH-002`, `UC-ADM-INV-001` | `auth`, `user` | Authentication, registration and invitation capabilities under `/api/v1` | TBD — V0.4 | TBD | `OI-006` **Resolved `BD-V04-006`**; `TD-001` Approved by ADR-004; `TD-003` partially Approved/Deferred |
| `USR-004`; `UC-ADM-USER-001` | `user` | Account/profile-lite and role administration capability | TBD — V0.4 | TBD | `OI-014` **Resolved `BD-V04-014`** |
...
| `QUIZ-001..QUIZ-010`; `UC-QUIZ-001..006` | `quiz` | Question Bank, test configuration, attempt, submission, result and ranking boundaries | TBD — V0.4 | TBD | `OI-002` **Resolved `BD-V04-002`**, `OI-007` **Resolved `BD-V04-007`**, `OI-008` **Resolved `BD-V04-008`**, `OI-009` **Resolved `BD-V04-009`** |
| `EDU-001..EDU-004`; `UC-EDU-001..002`, `UC-ADM-001` | `politicaleducation` | Program/topic/lecture/document capability; Test association: EDU reuses Quiz (BD-V04-011) | TBD — V0.4 | TBD | `OI-005`, `OI-011` **Resolved `BD-V04-011`**, `OI-012` **Resolved `BD-V04-012`**, `OI-015` |
...
| `WEEK-001..WEEK-005`; `UC-WEEK-001..003` | `weeklyquestion` | Configure/current/submit/grade/reveal capability; calendar-week lifecycle (BD-V04-010) | TBD — V0.4 | TBD | `OI-002` **Resolved `BD-V04-002`**, `OI-010` **Resolved `BD-V04-010`** |
| `COMP-001..COMP-007`; `UC-COMP-001..004` | `competition` | Admin-configurable policy; sources: Quiz + Weekly + manual adjustment; unit aggregation normalized average; periods weekly/monthly/yearly (BD-V04-002) | TBD — V0.4 | TBD | `OI-002` **Resolved `BD-V04-002`**, `OI-012` **Resolved `BD-V04-012`**, `OI-014` **Resolved `BD-V04-014`** |
| `REP-001..REP-006`; `UC-REP-001..003` | `dashboard` | Widget/report query and on-demand export boundary; popular-content metric = aggregate detail-view count (BD-V04-013) | TBD — V0.4 | TBD | `OI-002` **Resolved `BD-V04-002`**, `OI-013` **Resolved `BD-V04-013`**, `OI-014` **Resolved `BD-V04-014`**, `TD-005` |
...
| `USR-003` | `UC-AUTH-002`, `UC-ADM-INV-001` | `SCR-AUTH-002`, `SCR-ADM-003` | TBD | TBD | TBD | `OI-006` **Resolved `BD-V04-006`** — scoped single-use invitation tied to Tiểu đội |
...
| `QUIZ-004` | `UC-QUIZ-002`, `UC-QUIZ-004` | `SCR-ADM-009`, `SCR-QUIZ-002`, `SCR-QUIZ-003` | TBD | TBD | TBD | `OI-007` **Resolved `BD-V04-007`** — limited attempts, resume, fixed set |
| `QUIZ-005` | `UC-QUIZ-002`, `UC-QUIZ-003` | `SCR-ADM-009`, `SCR-QUIZ-001`, `SCR-QUIZ-002` | TBD | TBD | TBD | `OI-008` **Resolved `BD-V04-008`** — backend auto-finalize on timeout |
| `QUIZ-006` | `UC-QUIZ-004` | `SCR-QUIZ-003` | TBD | TBD | TBD | `OI-007` **Resolved `BD-V04-007`** — fixed question/answer order; resume confirmed |
| `QUIZ-007` | `UC-QUIZ-005` | `SCR-QUIZ-003`, `SCR-QUIZ-004` | TBD | TBD | TBD | Review Ready; auto-grade confirmed |
| `QUIZ-008` | `UC-QUIZ-005` | `SCR-QUIZ-004` | TBD | TBD | TBD | `OI-009` **Resolved `BD-V04-009`** — USER sees Đạt/Không đạt; raw score internal only |
| `QUIZ-009` | `UC-QUIZ-005`, `UC-COMP-003` | `SCR-QUIZ-004`, `SCR-COMP-001`, `SCR-COMP-002` | TBD | TBD | TBD | `OI-002` **Resolved `BD-V04-002`**, `OI-009` **Resolved `BD-V04-009`** — Quiz result eligible source |
| `QUIZ-010` | `UC-QUIZ-006` | `SCR-QUIZ-005` | TBD | TBD | TBD | `OI-009` **Resolved `BD-V04-009`** — ranking by highest eligible attempt, raw score descending |
| `EDU-001` | `UC-EDU-001`; test concept tracked in `OI-011` | `SCR-EDU-001`, `SCR-EDU-002`, `SCR-EDU-003`, `SCR-ADM-010` | TBD | TBD | TBD | `OI-011` **Resolved `BD-V04-011`** — EDU reuses Quiz; 0..1 Quiz per Lecture |
...
| `WEEK-001` | `UC-WEEK-001`, `UC-WEEK-002` | `SCR-ADM-012`, `SCR-WEEK-001` | TBD | TBD | TBD | `OI-010` **Resolved `BD-V04-010`** — calendar-week lifecycle, one submission |
...
| `WEEK-004` | `UC-WEEK-001`, `UC-WEEK-003` | `SCR-ADM-012`, `SCR-WEEK-002` | TBD | TBD | TBD | `OI-010` **Resolved `BD-V04-010`** — reveal after period closes |
| `WEEK-005` | `UC-WEEK-002`, `UC-COMP-003` | `SCR-WEEK-001`, `SCR-COMP-001`, `SCR-COMP-002` | TBD | TBD | TBD | `OI-002` **Resolved `BD-V04-002`**, `OI-010` **Resolved `BD-V04-010`** — Weekly result eligible source |
| `COMP-001` | `UC-COMP-001`, `UC-COMP-002` | `SCR-COMP-001`, `SCR-COMP-002` | TBD | TBD | TBD | `OI-014` **Resolved `BD-V04-014`** — ranking includes Tiểu đội; scopes: Cá nhân/Tiểu đội/Trung đội/Đại đội |
| `COMP-002` | `UC-COMP-002` | `SCR-COMP-002` | TBD | TBD | TBD | `OI-014` **Resolved `BD-V04-014`** — fixed hierarchy confirmed; all four ranking scopes |
| `COMP-003` | `UC-COMP-001`, `UC-COMP-003` | `SCR-COMP-001`, `SCR-ADM-013` | TBD | TBD | TBD | `OI-002` **Resolved `BD-V04-002`**, `OI-012` **Resolved `BD-V04-012`**, `OI-014` **Resolved `BD-V04-014`** |
| `COMP-004` | `UC-COMP-003` | `SCR-ADM-013`, `SCR-COMP-001` | TBD | TBD | TBD | `OI-012` **Resolved `BD-V04-012`** — learning completion excluded from MVP scoring |
...
| `ADM-003` | `UC-ADM-CFG-001`, `UC-COMP-004` | `SCR-ADM-015`, `SCR-ADM-013` | TBD | TBD | TBD | `OI-002` **Resolved `BD-V04-002`**, `OI-014` **Resolved `BD-V04-014`** — competition/org config policy approved |
...
| `REP-002` | `UC-REP-001` | `SCR-ADM-001` | TBD | TBD | TBD | `OI-002` **Resolved `BD-V04-002`** — competition scoring metric approved |
| `REP-003` | `UC-REP-001` | `SCR-ADM-001` | TBD | TBD | TBD | `OI-002` **Resolved `BD-V04-002`**, `OI-014` **Resolved `BD-V04-014`** — ranking scopes confirmed |
| `REP-004` | `UC-REP-001` | `SCR-ADM-001` | TBD | TBD | TBD | `OI-013` **Resolved `BD-V04-013`** — popular content = aggregate detail-view count |
